...
int main(int argc, char* argv[]) {
	...
	char   sandbox[REC_LENGTH * REC_WINDOW], *rec_iter, dbname[250];
	...
	//char * filelocation = "/home/stardica/Dropbox/WorkingRodiniaBenchmarks/data/nn/list1k.txt";
	char * filelocation = argv[1]; //get the file name and path.

	flist = fopen(filelocation, "r"); //open the db list.
	if(!flist) {
