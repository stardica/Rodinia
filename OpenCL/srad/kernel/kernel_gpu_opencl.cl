...
__kernel void extract_kernel(long d_Ne, __global fp* d_I){ // pointer to input image (DEVICE GLOBAL MEMORY)
...
__kernel void prepare_kernel(long d_Ne, __global fp* d_I, __global fp* d_sums, __global fp* d_sums2){
//pointer to output image (DEVICE GLOBAL MEMORY) // pointer to input image (DEVICE GLOBAL MEMORY) // indexes
...
__kernel void reduce_kernel(long d_Ne,  long d_no, int d_mul, __global fp* d_sums, __global fp* d_sums2, int gridDim){	
// number of elements in array // number of sums to reduce // increment // pointer to partial sums variable (DEVICE GLOBAL MEMORY)
...
__kernel void compress_kernel(long d_Ne, __global fp* d_I){// pointer to output image (DEVICE GLOBAL MEMORY)
